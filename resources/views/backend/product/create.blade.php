                    ...
                    <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mx-n15">
                            ...
                            <div class="col-md-8 mb-20 px-15">
                                ...
                                <input type="text" class="form-control ih-medium ip-light radius-xs b-light @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter Product Name" value="{{ old('name') }}" required>
                                @error('name')
                        ...
                        <div class="row mx-n15">
                            <div class="col-md-4 mb-20 px-15">
                                ...
                                <input type="number" name="regular_price" class="form-control ih-medium ip-light radius-xs b-light @error('regular_price') is-invalid @enderror" id="regular_price" placeholder="Enter Regular Price" value="{{ old('regular_price') }}" required>
                                @error('regular_price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-20 px-15">
                                ...
                                <input type="number" class="form-control ih-medium ip-light radius-xs b-light @error('sale_price') is-invalid @enderror" id="sale_price" name="sale_price" placeholder="Enter Sale Price" value="{{ old('sale_price') }}" required>
                                @error('sale_price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-20 px-15">
                                ...
                                <select class="custom-select form-control select-arrow-none ih-medium radius-xs b-light shadow-none color-light fs-14 @error('stock_status') is-invalid @enderror" id="stock_status" name="stock_status" required>
                                    ...
                                    <option value="1" @if(old('stock_status') == 1)selected @endif>In Stock</option>
                                    <option value="0" @if(old('stock_status') == 0)selected @endif>Out of Stock</option>
                                </select>
                                @error('stock_status')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row mx-n15">
                            ...
                            <div class="col-md-6 mb-20 px-15">
                                ...
                                <input type="file" class="form-control ip-light radius-xs b-light @error('images') is-invalid @enderror" id="images" name="images[]" accept="image/*" multiple required>
                                <div class="product_image_all_div" id="imagePreview"></div>
                                @error('images')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-20 px-15">
                                ...
                                <input type="file" class="form-control ip-light radius-xs b-light @error('thumbnail') is-invalid @enderror" id="thumbnail" name="thumbnail" required>
                                <img src="" alt="" id="thumbnailPreview" style="max-width: 100px; max-height: 100px; margin-top: 10px; display: none;">
                                @error('thumbnail')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <button class="btn btn-primary px-30" type="submit">Submit Add Product</button>
                    </form>
                </div>
            </div>
            <!-- ends: .card -->
        ...
        $('#images').change(function() {
            ...
            $.each(files, function(index, file) {
                ...
                reader.onload = function(e) {
                    ...
                    // const removeButton = $('<button>').addClass('remove_btn').html('<i class="fas fa-times"></i>');
                    // removeButton.click(function() {
                    //     $(this).parent().remove(); // Remove the parent div on button click
                    //     const removedIndex = $(this).parent().find('input').val();
                    //     $('#images')[0].files[removedIndex] = null; // Remove the file from the input field
                    // });

                    // const div = $('<div>').addClass('thumb_img_div').append(img, removeButton);
                    const div = $('<div>').addClass('thumb_img_div').append(img);

                    // const hiddenInput = $('<input>').attr({
                    //     type: 'hidden',
                    //     class: 'product_images_hidden',
                    //     name: 'images[]',
                    //     value: index
                    // });
